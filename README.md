...
```sh
  cd my-folder
  git clone https://github.com/hmunish/space-travelers-hub.git
```
...
- Twitter: [@twitterhandle](https://twitter.com/cwasswa)
- LinkedIn: [LinkedIn](https://linkedin.com/in/cosmas-wasswa)
...
Feel free to check the [issues page](https://github.com/hmunish/space-travelers-hub/issues).
